...
public class NowplayingModel {
    ...
    public NowplayingModel(String adult, String backdrop_path, long id, String org_title, String rel_day, String poster_path, float popularity, float vote_arg, int vote_count){
        this.adult = adult;
